...
vision = st.text_area("Company Vision (1–2 paragraphs)",
    value="To be the most trusted, tidy, and on-time landscaping team in our area—focused on repeat customers who value clear communication and quality results.",
    height=150)
