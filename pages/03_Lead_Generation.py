...
with st.expander("Channels table", expanded=False):
...
with col4: leads = st.number_input("# Leads", 0, 10000, 0)
with col5: quotes = st.number_input("# Quotes", 0, 10000, 0)
with col6: jobs = st.number_input("# Jobs", 0, 10000, 0)
with col7: revenue = st.number_input("Revenue", 0.0, 1000000.0, 0.0)
...
with st.expander("Leadgen metrics", expanded=False):
