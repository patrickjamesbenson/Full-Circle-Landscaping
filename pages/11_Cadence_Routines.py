...
with st.form("add_task"):
    ...
    with col1:
        dow = st.number_input("Day of week (0=Mon)", 0, 6, 0) if freq=="weekly" else None
    with col2:
        dom = st.number_input("Day of month (1-28)", 1, 28, 1) if freq=="monthly" else None
    with col3:
        hour = st.number_input("Hour (0-23)", 0, 23, 9)
    with col4:
        minute = st.number_input("Minute (0-59)", 0, 59, 0)
